...
4.2BSD是一个巨大的成功，就像McKusick指出的:“4.2卖出的拷贝(前18个月)比之前卖出的伯克利所有软件加起来还要多”。有几个操作系统公司是以4.2为基础开发的:DEC的Ultrix和Sun的post_UniSoft OS是其中最为有名的。虽然如此，还是有很多关于4.2BSD的抱怨，Mike Karels花费了第一年大部分的时间来优化系统。
