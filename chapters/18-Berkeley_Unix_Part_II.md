...
> 最初原型是BBN做出来的，他们将它交给了伯克利。它只能在750上运行，速度上限56KB/s，但CPU却被占用了100%。Bill一拿到它马上就开始修改它的代码。56KB的速度对BBN来说够用了，因为他们主干网的速度就是56KB/s，但是在互联网上这就太慢了。Bill大量修改代码使它的速度达到700KB/s。
