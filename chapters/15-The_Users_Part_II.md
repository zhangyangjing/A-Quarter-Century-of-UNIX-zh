...
bug修复，硬件增强，新的软件，优雅的hack。这就是USENIX，AUUG，UKUUG所致力于奉献的。我最喜爱的贡献来自Tom Ferrin(来自旧金山的加利福尼亚大学)，他用硬件改动解决了一个软件问题。他两页的信件(1977年9月9日)，一些代码还有一张图标发表在《;login:》上:
...
> 在和DEC的销售代表打了几通电话和看了几个小时的微码后，我们找到了一个简单的修改方案可以让PDP-11/70的cpu允许“mfpi”指令正常运行。这个方案会花费有经验人员15分钟的时间，你需要简短一个引脚并添加一个到M8138-YA内存管理电路板的跳线...
